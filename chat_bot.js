...
form.addEventListener("submit", async (e) => {
 ...
 function calculateSentiment(sentences, positiveWords, negativeWords, neutralWords) {
      ...
      function calculateSentimentRatios(userMessages) {
        ...
        window.location.href = '/templates/rock.html';
      else if(sentiment=='positive')
        window.location.href = '/templates/dance.html';
      else if(sentiment=='mild-negative')
        window.location.href = '/templates/melody.html';
      else
        window.location.href='/templates/break.html'
